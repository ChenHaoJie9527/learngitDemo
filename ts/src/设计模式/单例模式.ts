...
class ToolBarComponent_1 {
    static instance: ToolBarComponent_1;
    static getInstance(): ToolBarComponent_1 {
        if (!(this.instance)) {
...
class ToolBarComponent_2 {
    private static instance : ToolBarComponent_2;
    private constructor(){};
    static getInstance(): ToolBarComponent_2 {
        if(!(this.instance)){
